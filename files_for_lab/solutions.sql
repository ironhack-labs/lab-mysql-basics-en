...
limit 5;
 ...
 -- Query 2: Get the id value of the last client where the district_id equals 72. --
 SELECT client_id
FROM client
...
-- Query 17: In the loan table, for each day in December 1997, count the number of loans issued for each unique loan duration, ordered by date and duration, both in ascending order. Ignore days without any loans in your output.

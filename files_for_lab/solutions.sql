...
-- + -----------------------------------------------------
--   Query 6:
--   What is the loan amount of the lowest 5 account_ids 
--   in the loan table? Show the account_id and the 
...
--   loan duration, ordered by date and duration, 
--   both in ascending order. You can ignore days without 
--   any loans in your output.
-- + -----------------------------------------------------
SELECT `date`, duration, COUNT(loan_id)
FROM loan
GROUP BY `date`, duration
HAVING LEFT(`date`, 4) = 9712
